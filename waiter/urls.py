...
urlpatterns = [
                  ...
                  url(r'^insert_stuff/add_food_information/$', db_insert.add_food_information,
                      name='add_food_information'),
                  url(r'^insert_stuff/delete_food_information/$', db_insert.delete_food_information,
                      name='delete_food_information'),
                  url(r'^insert_stuff/add_food_category/$', db_insert.add_food_category, name='add_food_category'),
                  url(r'^insert_stuff/delete_food_category/$', db_insert.delete_food_category,
